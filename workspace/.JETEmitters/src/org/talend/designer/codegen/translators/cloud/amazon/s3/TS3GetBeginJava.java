...
public class TS3GetBeginJava
{
  ...
  protected final String TEXT_182 = NL + "\ttry{" + NL + "\t\t";
  protected final String TEXT_183 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_184 = " - Getting an object with key:\" + ";
  protected final String TEXT_185 = ");" + NL + "\t\t";
  protected final String TEXT_186 = NL + "\t\tconn_";
  protected final String TEXT_187 = ".getObject(new com.amazonaws.services.s3.model.GetObjectRequest(";
  protected final String TEXT_188 = ", ";
  protected final String TEXT_189 = "),new java.io.File(";
  protected final String TEXT_190 = "));" + NL + "\t\t";
  protected final String TEXT_191 = "\t" + NL + "\t\t\tlog.info(\"";
  protected final String TEXT_192 = " - Get the object successfully.\");" + NL + "\t\t";
  protected final String TEXT_193 = NL + "\t}catch(java.lang.Exception e_";
  ...
  protected final String TEXT_202 = NL + "\t}finally{" + NL + "\t\tif(conn_";
  protected final String TEXT_203 = " !=null){" + NL + "\t\t\tconn_";
  protected final String TEXT_204 = ".shutdown();" + NL + "\t\t}" + NL + "\t\t";
