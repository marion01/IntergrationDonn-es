...
package data_integration.loadetudedd1_0_1;
...
public class LoadEtudEDD1 implements TalendJob {
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(LoadEtudEDD1.this, new Object[] { e,
	...
	public static class etudiantsStruct implements
			routines.system.IPersistableRow<etudiantsStruct> {
		final static byte[] commonByteArrayLock_DATA_INTEGRATION_LoadEtudEDD1 = new byte[0];
		static byte[] commonByteArray_DATA_INTEGRATION_LoadEtudEDD1 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DATA_INTEGRATION_LoadEtudEDD1.length) {
					if (length < 1024
							&& commonByteArray_DATA_INTEGRATION_LoadEtudEDD1.length == 0) {
						commonByteArray_DATA_INTEGRATION_LoadEtudEDD1 = new byte[1024];
					} else {
						commonByteArray_DATA_INTEGRATION_LoadEtudEDD1 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DATA_INTEGRATION_LoadEtudEDD1, 0,
						length);
				strReturn = new String(
						commonByteArray_DATA_INTEGRATION_LoadEtudEDD1, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DATA_INTEGRATION_LoadEtudEDD1) {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (execStat) {
					if (resourceMap.get("inIterateVComp") == null) {
						...
						runStat.updateStatOnConnection("etudiants" + iterateId,
								0, 0);
				...
				String insert_tDBOutput_2 = "INSERT INTO `"
						+ "etudiants"
						+ "` (`codeEtudiant`,`annee`,`age`,`sexe`,`nationalite`,`bac`,`ville`,`niveau`,`csp`,`lv2`,`provenance`,`filiere`,`nbRattrapage`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)";
						...
						if (row1 != null) {
							...
							{ // start of Var scope
								...
								Var.annee_naiss = StringHandling.RIGHT(
										row1.date_naiss, 4);
								Var.annee_naiss_date = TalendDate.parseDate(
										"yyyy", Var.annee_naiss);
								Var.var2 = TalendDate.parseDate("yyyy",
										row1.annee);
								Var.age = (int) TalendDate.diffDate(Var.var2,
										Var.annee_naiss_date, "yyyy");
								Var.provenance = row1.Provenance == null ? ""
										: row1.Provenance.equals("n+i") ? "N+i"
												: row1.Provenance;// ###############################
								// ###############################
								// # Output tables
								...
								etudiants_tmp.niveau = row1.niveau.equals("") ? null
										: row1.niveau;
								etudiants_tmp.csp = row1.csp_par > 86 ? null
										: row1.csp_par;
								etudiants_tmp.lv2 = row1.Lv2.equals("") ? null
										: row1.Lv2;
								etudiants_tmp.provenance = Var.provenance
										.equals("") ? null : Var.provenance;
								etudiants_tmp.filiere = row1.Groupe.equals("") ? null
										: row1.Groupe;
								etudiants_tmp.nbRattrapage = row5.nbRattrapage == null ? 0
										: row5.nbRattrapage;
							...
							if (etudiants != null) {
								...
								if (execStat) {
									runStat.updateStatOnConnection("etudiants"
											+ iterateId, 1, 1);
								}

								whetherReject_tDBOutput_2 = false;
								pstmt_tDBOutput_2.setInt(1,
										etudiants.codeEtudiant);
								...
								if (etudiants.age == null) {
									...
									pstmt_tDBOutput_2.setInt(3, etudiants.age);
								}
								...
								if (etudiants.csp == null) {
									...
									pstmt_tDBOutput_2.setInt(9, etudiants.csp);
								}
								...
								if (etudiants.nbRattrapage == null) {
									...
									pstmt_tDBOutput_2.setInt(13,
											etudiants.nbRattrapage);
								}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					Object filename_tFileInputDelimited_2 = "C:/Talend/TOS_MDM-Studio-20180411_1414-V7.0.1/workspace/out.csv";
					...
					try {
						fid_tFileInputDelimited_2 = new org.talend.fileprocess.FileInputDelimited(
								"C:/Talend/TOS_MDM-Studio-20180411_1414-V7.0.1/workspace/out.csv",
								"windows-1252", ";", "\n", false, 0, 0, -1, -1,
								false);
					} catch (java.lang.Exception e) {
					...
					while (fid_tFileInputDelimited_2 != null
						...
						try {
							...
							row5.Nom = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 2;

							row5.Prenom = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 3;

							row5.Annee = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
					...
					if (!((Object) ("C:/Talend/TOS_MDM-Studio-20180411_1414-V7.0.1/workspace/out.csv") instanceof java.io.InputStream)) {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = LoadEtudEDD1.class.getClassLoader()
					.getResourceAsStream(
							"data_integration/loadetudedd1_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = LoadEtudEDD1.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : LoadEtudEDD1");
		}
...
/************************************************************************************************
 * 99886 characters generated by Talend Open Studio for MDM on the 14 juin 2019
 * 14:00:10 CEST
 ************************************************************************************************/
