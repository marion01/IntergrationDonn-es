...
package data_integration.fusion_promo_0_1;
...
/**
 * Job: Fusion_Promo Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class Fusion_Promo implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Fusion_Promo";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Fusion_Promo.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    final static byte[] commonByteArrayLock_DATA_INTEGRATION_Fusion_Promo = new byte[0];
    static byte[] commonByteArray_DATA_INTEGRATION_Fusion_Promo = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DATA_INTEGRATION_Fusion_Promo.length) {
				if(length < 1024 && commonByteArray_DATA_INTEGRATION_Fusion_Promo.length == 0) {
   					commonByteArray_DATA_INTEGRATION_Fusion_Promo = new byte[1024];
				} else {
   					commonByteArray_DATA_INTEGRATION_Fusion_Promo = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DATA_INTEGRATION_Fusion_Promo, 0, length);
			strReturn = new String(commonByteArray_DATA_INTEGRATION_Fusion_Promo, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DATA_INTEGRATION_Fusion_Promo) {
...
public static class output_promoStruct implements routines.system.IPersistableRow<output_promoStruct> {
    final static byte[] commonByteArrayLock_DATA_INTEGRATION_Fusion_Promo = new byte[0];
    static byte[] commonByteArray_DATA_INTEGRATION_Fusion_Promo = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(output_promoStruct other) {
...
output_promoStruct output_promo = new output_promoStruct();
	...
	currentComponent="tUnite_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("output_promo" + iterateId, 0, 0);
 ...
 */
  ...
  String directory_tFileList_1 = "C:/Users/thlavigne1/Desktop/Talend_files";
  final java.util.List<String> maskList_tFileList_1 = new java.util.ArrayList<String>();
  final java.util.List<java.util.regex.Pattern> patternList_tFileList_1 = new java.util.ArrayList<java.util.regex.Pattern>(); 
    maskList_tFileList_1.add("20*.*");  
 ...
 */
	NB_ITERATE_tFileInputExcel_1++;
					...
					if(execStat){				
	       				runStat.updateStatOnConnection("output_promo", 3, 0);
					}           			
...
output_promoStruct output_promo_tmp = new output_promoStruct();
// ###############################
 ...
 */
	...
	if(sheetList_tFileInputExcel_1.size()>0){
        ...
        for(int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++){
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Groupe";

				row1.Groupe = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row1.Groupe = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Lv2";

				row1.Lv2 = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row1.Lv2 = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Provenance";

				row1.Provenance = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row1.Provenance = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
...
// # Output table : 'output_promo'
output_promo_tmp.Nom = StringHandling.BTRIM(row1.Nom) ;
output_promo_tmp.Prenom = StringHandling.BTRIM(row1.Prenom) ;
output_promo_tmp.Groupe = row1.Groupe ;
output_promo_tmp.Lv2 = row1.Lv2 ;
output_promo_tmp.Provenance = row1.Provenance ;
output_promo_tmp.promo = StringHandling.LEFT(((String)globalMap.get("tFileList_1_CURRENT_FILE")),9);
output_promo_tmp.niveau = StringHandling.LEFT(StringHandling.RIGHT((String)globalMap.get("tFileList_1_CURRENT_FILE"),8),3) ;
output_promo_tmp.annee_diplome = StringHandling.RIGHT(StringHandling.LEFT((String)globalMap.get("tFileList_1_CURRENT_FILE"),9),4) ;
output_promo = output_promo_tmp;
// ###############################
 ...
 */
// Start of branch "output_promo"
if(output_promo != null) { 
	...
	currentComponent="tUnite_1";
			...
			//output_promo
				...
				if(execStat){
					runStat.updateStatOnConnection("output_promo"+iterateId,1, 1);
				} 
...
// for output
			...
			row2.Nom = output_promo.Nom;								
			row2.Prenom = output_promo.Prenom;								
			row2.Groupe = output_promo.Groupe;								
			row2.Lv2 = output_promo.Lv2;								
			row2.Provenance = output_promo.Provenance;								
			row2.promo = output_promo.promo;								
			row2.niveau = output_promo.niveau;								
			row2.annee_diplome = output_promo.annee_diplome;			
...
String[] row_tBufferOutput_1=new String[]{"","","","","","","","",};		
	    if(row2.Nom != null){
	            ...
	            row_tBufferOutput_1[0] = row2.Nom;
	    ...
	    if(row2.Prenom != null){
	            ...
	            row_tBufferOutput_1[1] = row2.Prenom;
	    ...
	    if(row2.Groupe != null){
	            ...
	            row_tBufferOutput_1[2] = row2.Groupe;
	    ...
	    if(row2.Lv2 != null){
	            ...
	            row_tBufferOutput_1[3] = row2.Lv2;
	    ...
	    if(row2.Provenance != null){
	            ...
	            row_tBufferOutput_1[4] = row2.Provenance;
	    ...
	    if(row2.promo != null){
	            ...
	            row_tBufferOutput_1[5] = row2.promo;
	    ...
	    if(row2.niveau != null){
	            ...
	            row_tBufferOutput_1[6] = row2.niveau;
	    ...
	    if(row2.annee_diplome != null){
	            ...
	            row_tBufferOutput_1[7] = row2.annee_diplome;
...
globalMap.put("tUnite_1_NB_LINE", nb_line_tUnite_1);
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("output_promo"+iterateId,2, 0); 
			 	}
			}
 ...
 */
    ...
    public static void main(String[] args){
        final Fusion_Promo Fusion_PromoClass = new Fusion_Promo();

        int exitCode = Fusion_PromoClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Fusion_Promo.class.getClassLoader().getResourceAsStream("data_integration/fusion_promo_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Fusion_Promo.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Fusion_Promo");
        }
...
/************************************************************************************************
 *     68439 characters generated by Talend Open Studio for MDM 
 *     on the 14 juin 2019 13:59:09 CEST
 ************************************************************************************************/