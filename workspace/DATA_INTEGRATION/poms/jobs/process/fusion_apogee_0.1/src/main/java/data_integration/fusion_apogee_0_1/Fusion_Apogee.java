...
package data_integration.fusion_apogee_0_1;
...
public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
    final static byte[] commonByteArrayLock_DATA_INTEGRATION_Fusion_Apogee = new byte[0];
    static byte[] commonByteArray_DATA_INTEGRATION_Fusion_Apogee = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DATA_INTEGRATION_Fusion_Apogee.length) {
				if(length < 1024 && commonByteArray_DATA_INTEGRATION_Fusion_Apogee.length == 0) {
   					commonByteArray_DATA_INTEGRATION_Fusion_Apogee = new byte[1024];
				} else {
   					commonByteArray_DATA_INTEGRATION_Fusion_Apogee = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DATA_INTEGRATION_Fusion_Apogee, 0, length);
			strReturn = new String(commonByteArray_DATA_INTEGRATION_Fusion_Apogee, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DATA_INTEGRATION_Fusion_Apogee) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Fusion_Apogee.class.getClassLoader().getResourceAsStream("data_integration/fusion_apogee_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     79620 characters generated by Talend Open Studio for MDM 
