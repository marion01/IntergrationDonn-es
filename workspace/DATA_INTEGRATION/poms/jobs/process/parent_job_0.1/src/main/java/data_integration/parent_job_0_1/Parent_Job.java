...
package data_integration.parent_job_0_1;
...
public class Parent_Job implements TalendJob {
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Parent_Job.this, new Object[] { e,
	...
	public static class out1Struct implements
		...
		final static byte[] commonByteArrayLock_DATA_INTEGRATION_Parent_Job = new byte[0];
		static byte[] commonByteArray_DATA_INTEGRATION_Parent_Job = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DATA_INTEGRATION_Parent_Job.length) {
					if (length < 1024
							&& commonByteArray_DATA_INTEGRATION_Parent_Job.length == 0) {
						commonByteArray_DATA_INTEGRATION_Parent_Job = new byte[1024];
					} else {
						commonByteArray_DATA_INTEGRATION_Parent_Job = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DATA_INTEGRATION_Parent_Job, 0,
						length);
				strReturn = new String(
						commonByteArray_DATA_INTEGRATION_Parent_Job, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DATA_INTEGRATION_Parent_Job) {
	...
	public static class row3Struct implements
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime
						* result
						+ ((this.nom_patro == null) ? 0 : this.nom_patro
								.hashCode());
	...
	public static class after_tRunJob_1Struct implements
			routines.system.IPersistableRow<after_tRunJob_1Struct> {
		final static byte[] commonByteArrayLock_DATA_INTEGRATION_Parent_Job = new byte[0];
		static byte[] commonByteArray_DATA_INTEGRATION_Parent_Job = new byte[0];
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited_1 = (new java.io.File(
						"C:/ID/out/fusionOut.csv")).getAbsolutePath().replace(
						"\\", "/");
				...
				if (startRowNum_tFileOutputExcel_1 == 0) {
					...
					writableSheet_tFileOutputExcel_1
							.addCell(new jxl.write.Label(0,
									nb_line_tFileOutputExcel_1, "code_etu"));
					// modif end
					fitWidth_tFileOutputExcel_1[0] = fitWidth_tFileOutputExcel_1[0] > 8 ? fitWidth_tFileOutputExcel_1[0]
							: 8;
					// modif start
					writableSheet_tFileOutputExcel_1
							.addCell(new jxl.write.Label(1,
									nb_line_tFileOutputExcel_1, "annee"));
					// modif end
					...
					writableSheet_tFileOutputExcel_1
							.addCell(new jxl.write.Label(2,
									nb_line_tFileOutputExcel_1, "nom_patro"));
					// modif end
					...
					writableSheet_tFileOutputExcel_1
							.addCell(new jxl.write.Label(4,
									nb_line_tFileOutputExcel_1, "date_naiss"));
					// modif end
					fitWidth_tFileOutputExcel_1[4] = fitWidth_tFileOutputExcel_1[4] > 10 ? fitWidth_tFileOutputExcel_1[4]
							: 10;
					// modif start
					writableSheet_tFileOutputExcel_1
							.addCell(new jxl.write.Label(5,
									nb_line_tFileOutputExcel_1, "sexe"));
					// modif end
					...
					writableSheet_tFileOutputExcel_1
							.addCell(new jxl.write.Label(6,
									nb_line_tFileOutputExcel_1, "nationalite"));
					// modif end
					fitWidth_tFileOutputExcel_1[6] = fitWidth_tFileOutputExcel_1[6] > 11 ? fitWidth_tFileOutputExcel_1[6]
							: 11;
					// modif start
					writableSheet_tFileOutputExcel_1
							.addCell(new jxl.write.Label(7,
									nb_line_tFileOutputExcel_1, "bac"));
					// modif end
					fitWidth_tFileOutputExcel_1[7] = fitWidth_tFileOutputExcel_1[7] > 3 ? fitWidth_tFileOutputExcel_1[7]
							: 3;
					// modif start
					writableSheet_tFileOutputExcel_1
							.addCell(new jxl.write.Label(8,
									nb_line_tFileOutputExcel_1, "bur_distr"));
					// modif end
					...
					writableSheet_tFileOutputExcel_1
							.addCell(new jxl.write.Label(9,
									nb_line_tFileOutputExcel_1, "cod_pays"));
					// modif end
					fitWidth_tFileOutputExcel_1[9] = fitWidth_tFileOutputExcel_1[9] > 8 ? fitWidth_tFileOutputExcel_1[9]
							: 8;
					// modif start
					writableSheet_tFileOutputExcel_1
							.addCell(new jxl.write.Label(10,
									nb_line_tFileOutputExcel_1, "etape"));
					// modif end
					fitWidth_tFileOutputExcel_1[10] = fitWidth_tFileOutputExcel_1[10] > 5 ? fitWidth_tFileOutputExcel_1[10]
							: 5;
					// modif start
					writableSheet_tFileOutputExcel_1
							.addCell(new jxl.write.Label(11,
									nb_line_tFileOutputExcel_1, "csp_par"));
					// modif end
					fitWidth_tFileOutputExcel_1[11] = fitWidth_tFileOutputExcel_1[11] > 7 ? fitWidth_tFileOutputExcel_1[11]
							: 7;
					// modif start
					writableSheet_tFileOutputExcel_1
							.addCell(new jxl.write.Label(12,
									nb_line_tFileOutputExcel_1, "cod_dep"));
					// modif end
					fitWidth_tFileOutputExcel_1[12] = fitWidth_tFileOutputExcel_1[12] > 7 ? fitWidth_tFileOutputExcel_1[12]
							: 7;
					// modif start
					writableSheet_tFileOutputExcel_1
							.addCell(new jxl.write.Label(13,
									nb_line_tFileOutputExcel_1, "cod_post"));
					// modif end
					fitWidth_tFileOutputExcel_1[13] = fitWidth_tFileOutputExcel_1[13] > 8 ? fitWidth_tFileOutputExcel_1[13]
							: 8;
				...
				data_integration.fusion_apogee_0_1.Fusion_Apogee childJob_tRunJob_1 = new data_integration.fusion_apogee_0_1.Fusion_Apogee();
				// pass DataSources
				...
				for (String[] item_tRunJob_1 : childReturn_tRunJob_1) {
					if (childJob_tRunJob_1.hastBufferOutputComponent() || true) {
						...
						if (0 < item_tRunJob_1.length) {
							...
							row1.code_etu = ParserUtils
									.parseTo_Integer(item_tRunJob_1[0]);
						...
						if (11 < item_tRunJob_1.length) {
							...
							row1.csp_par = ParserUtils
									.parseTo_Integer(item_tRunJob_1[11]);
					...
					if (row1.csp_par != null) {
						...
						int currentWith_11_tFileOutputExcel_1 = String
								.valueOf(
										((jxl.write.Number) cell_11_tFileOutputExcel_1)
												.getValue()).trim().length();
					...
					if (row1.cod_post != null) {
						...
						int currentWith_13_tFileOutputExcel_1 = cell_13_tFileOutputExcel_1
								.getContents().trim().length();
					...
					{ // start of Var scope
						...
						Var.provenance = row4.Provenance == null ? ""
								: row4.Provenance.equals("n+i") ? "N+i"
										: row4.Provenance;// ###############################
						// ###############################
						// # Output tables
					...
					if (out1 != null) {
						...
						if (out1.code_etu != null) {
							sb_tFileOutputDelimited_1.append(out1.code_etu);
						}
						sb_tFileOutputDelimited_1
								.append(OUT_DELIM_tFileOutputDelimited_1);
						if (out1.annee != null) {
							sb_tFileOutputDelimited_1.append(out1.annee);
						}
						sb_tFileOutputDelimited_1
								.append(OUT_DELIM_tFileOutputDelimited_1);
						if (out1.nom_patro != null) {
							sb_tFileOutputDelimited_1.append(out1.nom_patro);
						}
						sb_tFileOutputDelimited_1
								.append(OUT_DELIM_tFileOutputDelimited_1);
						if (out1.prenom != null) {
							sb_tFileOutputDelimited_1.append(out1.prenom);
						}
						sb_tFileOutputDelimited_1
								.append(OUT_DELIM_tFileOutputDelimited_1);
						if (out1.date_naiss != null) {
							sb_tFileOutputDelimited_1.append(out1.date_naiss);
						}
						sb_tFileOutputDelimited_1
								.append(OUT_DELIM_tFileOutputDelimited_1);
						if (out1.sexe != null) {
						...
						if (out1.nationalite != null) {
							sb_tFileOutputDelimited_1.append(out1.nationalite);
						}
						sb_tFileOutputDelimited_1
								.append(OUT_DELIM_tFileOutputDelimited_1);
						if (out1.bac != null) {
							sb_tFileOutputDelimited_1.append(out1.bac);
						}
						sb_tFileOutputDelimited_1
								.append(OUT_DELIM_tFileOutputDelimited_1);
						if (out1.bur_distr != null) {
							sb_tFileOutputDelimited_1.append(out1.bur_distr);
						}
						sb_tFileOutputDelimited_1
								.append(OUT_DELIM_tFileOutputDelimited_1);
						if (out1.etape != null) {
							sb_tFileOutputDelimited_1.append(out1.etape);
						}
						sb_tFileOutputDelimited_1
								.append(OUT_DELIM_tFileOutputDelimited_1);
						if (out1.csp_par != null) {
							sb_tFileOutputDelimited_1.append(out1.csp_par);
						}
						sb_tFileOutputDelimited_1
								.append(OUT_DELIM_tFileOutputDelimited_1);
						if (out1.promo != null) {
							sb_tFileOutputDelimited_1.append(out1.promo);
						}
						sb_tFileOutputDelimited_1
								.append(OUT_DELIM_tFileOutputDelimited_1);
						if (out1.niveau != null) {
							sb_tFileOutputDelimited_1.append(out1.niveau);
						}
						sb_tFileOutputDelimited_1
								.append(OUT_DELIM_tFileOutputDelimited_1);
						if (out1.Groupe != null) {
						...
						sb_tFileOutputDelimited_1
								.append(OUT_DELIM_tFileOutputDelimited_1);
						if (out1.Lv2 != null) {
							sb_tFileOutputDelimited_1.append(out1.Lv2);
						}
						sb_tFileOutputDelimited_1
								.append(OUT_DELIM_tFileOutputDelimited_1);
						if (out1.Provenance != null) {
							sb_tFileOutputDelimited_1.append(out1.Provenance);
						}
						sb_tFileOutputDelimited_1
								.append(OUT_DELIM_tFileOutputDelimited_1);
						if (out1.cod_pays != null) {
							sb_tFileOutputDelimited_1.append(out1.cod_pays);
						}
						sb_tFileOutputDelimited_1
								.append(OUT_DELIM_tFileOutputDelimited_1);
						if (out1.cod_dep != null) {
							sb_tFileOutputDelimited_1.append(out1.cod_dep);
						}
						sb_tFileOutputDelimited_1
								.append(OUT_DELIM_tFileOutputDelimited_1);
						if (out1.cod_post != null) {
							sb_tFileOutputDelimited_1.append(out1.cod_post);
						}
						sb_tFileOutputDelimited_1
	...
	public static class row4Struct implements
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime
						* result
						+ ((this.annee_diplome == null) ? 0
								: this.annee_diplome.hashCode());
		...
		public int compareTo(row4Struct other) {
			...
			returnValue = checkNullsAndCompare(this.annee_diplome,
					other.annee_diplome);
			if (returnValue != 0) {
				return returnValue;
			}
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// source node:tFileOutputExcel_2 - inputs:(row2)
				...
				if (startRowNum_tFileOutputExcel_2 == 0) {
					...
					writableSheet_tFileOutputExcel_2
							.addCell(new jxl.write.Label(0,
									nb_line_tFileOutputExcel_2, "Nom"));
					// modif end
					fitWidth_tFileOutputExcel_2[0] = fitWidth_tFileOutputExcel_2[0] > 3 ? fitWidth_tFileOutputExcel_2[0]
							: 3;
					// modif start
					writableSheet_tFileOutputExcel_2
							.addCell(new jxl.write.Label(1,
									nb_line_tFileOutputExcel_2, "Prenom"));
					// modif end
					fitWidth_tFileOutputExcel_2[1] = fitWidth_tFileOutputExcel_2[1] > 6 ? fitWidth_tFileOutputExcel_2[1]
							: 6;
					// modif start
					writableSheet_tFileOutputExcel_2
							.addCell(new jxl.write.Label(2,
									nb_line_tFileOutputExcel_2, "Groupe"));
					// modif end
					...
					writableSheet_tFileOutputExcel_2
							.addCell(new jxl.write.Label(3,
									nb_line_tFileOutputExcel_2, "Lv2"));
					// modif end
					fitWidth_tFileOutputExcel_2[3] = fitWidth_tFileOutputExcel_2[3] > 3 ? fitWidth_tFileOutputExcel_2[3]
							: 3;
					// modif start
					writableSheet_tFileOutputExcel_2
							.addCell(new jxl.write.Label(4,
									nb_line_tFileOutputExcel_2, "Provenance"));
					// modif end
					fitWidth_tFileOutputExcel_2[4] = fitWidth_tFileOutputExcel_2[4] > 10 ? fitWidth_tFileOutputExcel_2[4]
							: 10;
					// modif start
					writableSheet_tFileOutputExcel_2
							.addCell(new jxl.write.Label(5,
									nb_line_tFileOutputExcel_2, "promo"));
					// modif end
					fitWidth_tFileOutputExcel_2[5] = fitWidth_tFileOutputExcel_2[5] > 5 ? fitWidth_tFileOutputExcel_2[5]
							: 5;
					// modif start
					writableSheet_tFileOutputExcel_2
							.addCell(new jxl.write.Label(6,
									nb_line_tFileOutputExcel_2, "niveau"));
					// modif end
					fitWidth_tFileOutputExcel_2[6] = fitWidth_tFileOutputExcel_2[6] > 6 ? fitWidth_tFileOutputExcel_2[6]
							: 6;
					// modif start
					writableSheet_tFileOutputExcel_2
							.addCell(new jxl.write.Label(7,
									nb_line_tFileOutputExcel_2, "annee_diplome"));
					// modif end
					fitWidth_tFileOutputExcel_2[7] = fitWidth_tFileOutputExcel_2[7] > 13 ? fitWidth_tFileOutputExcel_2[7]
							: 13;
				...
				data_integration.fusion_promo_0_1.Fusion_Promo childJob_tRunJob_2 = new data_integration.fusion_promo_0_1.Fusion_Promo();
				// pass DataSources
				...
				for (String[] item_tRunJob_2 : childReturn_tRunJob_2) {
					...
					if (row2.Provenance != null) {
						...
						// modif ends
						writableSheet_tFileOutputExcel_2
								.addCell(cell_4_tFileOutputExcel_2);
						int currentWith_4_tFileOutputExcel_2 = cell_4_tFileOutputExcel_2
								.getContents().trim().length();
						fitWidth_tFileOutputExcel_2[4] = fitWidth_tFileOutputExcel_2[4] > currentWith_4_tFileOutputExcel_2 ? fitWidth_tFileOutputExcel_2[4]
					...
					if (row2.promo != null) {
						...
						// modif ends
						writableSheet_tFileOutputExcel_2
								.addCell(cell_5_tFileOutputExcel_2);
						int currentWith_5_tFileOutputExcel_2 = cell_5_tFileOutputExcel_2
								.getContents().trim().length();
						fitWidth_tFileOutputExcel_2[5] = fitWidth_tFileOutputExcel_2[5] > currentWith_5_tFileOutputExcel_2 ? fitWidth_tFileOutputExcel_2[5]
					...
					if (row2.niveau != null) {
						...
						// modif ends
						writableSheet_tFileOutputExcel_2
								.addCell(cell_6_tFileOutputExcel_2);
						int currentWith_6_tFileOutputExcel_2 = cell_6_tFileOutputExcel_2
								.getContents().trim().length();
						fitWidth_tFileOutputExcel_2[6] = fitWidth_tFileOutputExcel_2[6] > currentWith_6_tFileOutputExcel_2 ? fitWidth_tFileOutputExcel_2[6]
					...
					if (row2.annee_diplome != null) {
						...
						// modif ends
						writableSheet_tFileOutputExcel_2
								.addCell(cell_7_tFileOutputExcel_2);
						int currentWith_7_tFileOutputExcel_2 = cell_7_tFileOutputExcel_2
								.getContents().trim().length();
						fitWidth_tFileOutputExcel_2[7] = fitWidth_tFileOutputExcel_2[7] > currentWith_7_tFileOutputExcel_2 ? fitWidth_tFileOutputExcel_2[7]
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Parent_Job.class.getClassLoader()
					.getResourceAsStream(
							"data_integration/parent_job_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = Parent_Job.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : Parent_Job");
		}
...
/************************************************************************************************
 * 149856 characters generated by Talend Open Studio for MDM on the 14 juin 2019
 * 14:43:00 CEST
 ************************************************************************************************/
