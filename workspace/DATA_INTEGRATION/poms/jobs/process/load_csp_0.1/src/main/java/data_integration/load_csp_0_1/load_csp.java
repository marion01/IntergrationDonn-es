...
package data_integration.load_csp_0_1;
...
public class load_csp implements TalendJob {
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(load_csp.this, new Object[] { e,
	...
	public static class row11Struct implements
		...
		final static byte[] commonByteArrayLock_DATA_INTEGRATION_load_csp = new byte[0];
		static byte[] commonByteArray_DATA_INTEGRATION_load_csp = new byte[0];
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime * result
						+ ((this.csp == null) ? 0 : this.csp.hashCode());
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DATA_INTEGRATION_load_csp.length) {
					if (length < 1024
							&& commonByteArray_DATA_INTEGRATION_load_csp.length == 0) {
						commonByteArray_DATA_INTEGRATION_load_csp = new byte[1024];
					} else {
						commonByteArray_DATA_INTEGRATION_load_csp = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DATA_INTEGRATION_load_csp, 0,
						length);
				strReturn = new String(
						commonByteArray_DATA_INTEGRATION_load_csp, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DATA_INTEGRATION_load_csp) {
	...
	public static class copyOfd_cspStruct implements
			routines.system.IPersistableRow<copyOfd_cspStruct> {
		final static byte[] commonByteArrayLock_DATA_INTEGRATION_load_csp = new byte[0];
		static byte[] commonByteArray_DATA_INTEGRATION_load_csp = new byte[0];
		protected static final int DEFAULT_HASHCODE = 1;
		protected static final int PRIME = 31;
	...
	public void tFileInputExcel_1Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				java.sql.Statement stmtClear_tDBOutput_1 = conn_tDBOutput_1
						.createStatement();
				stmtClear_tDBOutput_1.executeUpdate("DELETE FROM `"
						+ tableName_tDBOutput_1 + "`");
				stmtClear_tDBOutput_1.close();

				String insert_tDBOutput_1 = "INSERT INTO `" + "d_csp"
						+ "` (`csp`,`cat_csp`) VALUES (?,?)";
				...
				if (execStat) {
					if (resourceMap.get("inIterateVComp") == null) {
						...
						runStat.updateStatOnConnection("copyOfd_csp"
								+ iterateId, 0, 0);
				...
				Object source_tFileInputExcel_1 = "C:/Users/thlavigne1/Desktop/Talend_files/csp.xlsx";
				...
				try {
					...
					sheetList_tFileInputExcel_1
							.addAll(regexUtil_tFileInputExcel_1.getSheets(
									workbook_tFileInputExcel_1, "cspn2", false));
						...
						for (int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++) {
							...
							if (row4 != null) {
								...
								if (tHash_Lookup_row12 != null
									...
									// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row12' and it contains more one result from keys :  row12.Code = '"
									// + row12HashKey.Code + "'");
								} // G 071
								...
								if (copyOfd_csp != null) {
									...
									if (!keystUniqRow_1
										...
										row11.csp = copyOfd_csp.csp;
										row11.cat_csp = copyOfd_csp.cat_csp;
	...
	public void tFileInputExcel_2Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// inputs:(after_tFileInputExcel_1) outputs:(row12,row12) |
				// target node:tAdvancedHash_row12 - inputs:(row12) outputs:()
				// linked node: tMap_1 - inputs:(row4,row12)
				// outputs:(copyOfd_csp)
				...
				Object source_tFileInputExcel_2 = "C:/Users/thlavigne1/Desktop/Talend_files/csp.xlsx";
				...
				try {
					...
					sheetList_tFileInputExcel_2
							.addAll(regexUtil_tFileInputExcel_2.getSheets(
									workbook_tFileInputExcel_2, "cspn1", false));
					...
					if (sheetList_tFileInputExcel_2.size() > 0) {
						...
						for (int i_tFileInputExcel_2 = begin_line_tFileInputExcel_2; i_tFileInputExcel_2 < end_line_tFileInputExcel_2; i_tFileInputExcel_2++) {
							...
							if (row12 != null) {
								...
								/**
								 * [tAdvancedHash_row12 process_data_begin ]
								 * start
								 */
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = load_csp.class.getClassLoader()
					.getResourceAsStream(
							"data_integration/load_csp_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = load_csp.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : load_csp");
		}
...
/************************************************************************************************
 * 100616 characters generated by Talend Open Studio for MDM on the 13 juin 2019
 * 17:53:06 CEST
 ************************************************************************************************/
