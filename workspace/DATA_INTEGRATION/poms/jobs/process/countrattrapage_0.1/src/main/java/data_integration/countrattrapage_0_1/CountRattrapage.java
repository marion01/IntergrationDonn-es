...
package data_integration.countrattrapage_0_1;
...
public class CountRattrapage implements TalendJob {
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(CountRattrapage.this, new Object[] { e,
	...
	public static class row5Struct implements
		...
		final static byte[] commonByteArrayLock_DATA_INTEGRATION_CountRattrapage = new byte[0];
		static byte[] commonByteArray_DATA_INTEGRATION_CountRattrapage = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DATA_INTEGRATION_CountRattrapage.length) {
					if (length < 1024
							&& commonByteArray_DATA_INTEGRATION_CountRattrapage.length == 0) {
						commonByteArray_DATA_INTEGRATION_CountRattrapage = new byte[1024];
					} else {
						commonByteArray_DATA_INTEGRATION_CountRattrapage = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DATA_INTEGRATION_CountRattrapage,
						0, length);
				strReturn = new String(
						commonByteArray_DATA_INTEGRATION_CountRattrapage, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DATA_INTEGRATION_CountRattrapage) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				class AggOperationStruct_tAggregateRow_1 { // G_OutBegin_AggR_100
					...
					public int hashCode() {
						if (this.hashCodeDirty) {
							...
							result = prime
									* result
									+ ((this.nom == null) ? 0 : this.nom
											.hashCode());

							result = prime
									* result
									+ ((this.prenom == null) ? 0 : this.prenom
											.hashCode());

							result = prime
									* result
									+ ((this.annee == null) ? 0 : this.annee
											.hashCode());
				...
				try {
					...
					while (rs_tDBInput_6.next()) {
						...
						if (tHash_Lookup_row1 != null
							...
							// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row1' and it contains more one result from keys :  row1.idEpreuve = '"
							// + row1HashKey.idEpreuve + "'");
						} // G 071
						...
						if (tHash_Lookup_row2 != null
							...
							// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row2' and it contains more one result from keys :  row2.idEleve = '"
							// + row2HashKey.idEleve + "'");
						} // G 071
						...
						{ // start of Var scope
							...
							out_tmp.nom = StringHandling
									.BTRIM(row2.nomEtudiant);
							out_tmp.prenom = StringHandling
									.BTRIM(row2.prenomEtudiant);
							out_tmp.annee = StringHandling.RIGHT(
									row1.anneeScolaire, 4);
							out = out_tmp;
							// ###############################
				...
				for (AggOperationStruct_tAggregateRow_1 aggregated_row_tAggregateRow_1 : values_tAggregateRow_1) { // G_AggR_600
					...
					sb_tFileOutputDelimited_1.append(row5.idEpreuve);
					...
					sb_tFileOutputDelimited_1
							.append(OUT_DELIM_tFileOutputDelimited_1);
					if (row5.annee != null) {
						sb_tFileOutputDelimited_1.append(row5.annee);
					}
					sb_tFileOutputDelimited_1
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// source node:tDBInput_2 - inputs:(after_tDBInput_6)
				...
				try {
					...
					while (rs_tDBInput_2.next()) {
						...
						if (colQtyInRs_tDBInput_2 < 2) {
							...
							row1.dateEpreuve = routines.system.JDBCUtil
						...
						if (colQtyInRs_tDBInput_2 < 3) {
							...
							row1.salleEpreuve = routines.system.JDBCUtil
						...
						if (colQtyInRs_tDBInput_2 < 5) {
							...
							row1.nomEpreuve = routines.system.JDBCUtil
						...
						if (colQtyInRs_tDBInput_2 < 6) {
							...
							row1.anneeScolaire = routines.system.JDBCUtil
						...
						if (colQtyInRs_tDBInput_2 < 7) {
							...
							row1.niveau = routines.system.JDBCUtil.getString(
				...
				try {
					...
					while (rs_tDBInput_4.next()) {
						...
						if (colQtyInRs_tDBInput_4 < 2) {
							...
							row2.nomEtudiant = routines.system.JDBCUtil
						...
						if (colQtyInRs_tDBInput_4 < 3) {
							...
							row2.prenomEtudiant = routines.system.JDBCUtil
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = CountRattrapage.class
					.getClassLoader().getResourceAsStream(
							"data_integration/countrattrapage_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = CountRattrapage.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : CountRattrapage");
		}
...
/************************************************************************************************
 * 120579 characters generated by Talend Open Studio for MDM on the 14 juin 2019
 * 13:52:06 CEST
 ************************************************************************************************/
