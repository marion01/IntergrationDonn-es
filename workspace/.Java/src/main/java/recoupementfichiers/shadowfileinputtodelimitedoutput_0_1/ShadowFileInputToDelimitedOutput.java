...
package recoupementfichiers.shadowfileinputtodelimitedoutput_0_1;
...
public class ShadowFileInputToDelimitedOutput implements TalendJob {
	...
	public static class RowStruct implements
		...
		final static byte[] commonByteArrayLock_RECOUPEMENTFICHIERS_ShadowFileInputToDelimitedOutput = new byte[0];
		static byte[] commonByteArray_RECOUPEMENTFICHIERS_ShadowFileInputToDelimitedOutput = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_RECOUPEMENTFICHIERS_ShadowFileInputToDelimitedOutput.length) {
					if (length < 1024
							&& commonByteArray_RECOUPEMENTFICHIERS_ShadowFileInputToDelimitedOutput.length == 0) {
						commonByteArray_RECOUPEMENTFICHIERS_ShadowFileInputToDelimitedOutput = new byte[1024];
					} else {
						commonByteArray_RECOUPEMENTFICHIERS_ShadowFileInputToDelimitedOutput = new byte[2 * length];
					}
				}
				dis.readFully(
						commonByteArray_RECOUPEMENTFICHIERS_ShadowFileInputToDelimitedOutput,
						0, length);
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_RECOUPEMENTFICHIERS_ShadowFileInputToDelimitedOutput) {
	...
	public void tFileInputExcelProcess(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				class BytesLimit65535_tFileOutputDelimited {
					public void limitLog4jByte() throws Exception {

					}
				}

				new BytesLimit65535_tFileOutputDelimited().limitLog4jByte();

				String fileName_tFileOutputDelimited = "";
				fileName_tFileOutputDelimited = (new java.io.File(
						"C:/Talend/TOS_MDM-Studio-20180411_1414-V7.0.1/workspace/RECOUPEMENTFICHIERS/temp/preview/fusion.csv"))
				...
				class BytesLimit65535_tFileInputExcel {
					public void limitLog4jByte() throws Exception {

					}
				}

				new BytesLimit65535_tFileInputExcel().limitLog4jByte();
				...
				final jxl.WorkbookSettings workbookSettings_tFileInputExcel = new jxl.WorkbookSettings();
				workbookSettings_tFileInputExcel.setDrawingsDisabled(true);
				workbookSettings_tFileInputExcel.setEncoding("UTF-8");

				Object source_tFileInputExcel = "C:/Talend/TOS_MDM-Studio-20180411_1414-V7.0.1/workspace/fusion.xls";
				final jxl.Workbook workbook_tFileInputExcel;

				java.io.InputStream toClose_tFileInputExcel = null;
				java.io.BufferedInputStream buffIStreamtFileInputExcel = null;
				try {
					if (source_tFileInputExcel instanceof java.io.InputStream) {
						toClose_tFileInputExcel = (java.io.InputStream) source_tFileInputExcel;
						buffIStreamtFileInputExcel = new java.io.BufferedInputStream(
								toClose_tFileInputExcel);
						workbook_tFileInputExcel = jxl.Workbook.getWorkbook(
								buffIStreamtFileInputExcel,
								workbookSettings_tFileInputExcel);
					} else if (source_tFileInputExcel instanceof String) {
						toClose_tFileInputExcel = new java.io.FileInputStream(
								source_tFileInputExcel.toString());
						buffIStreamtFileInputExcel = new java.io.BufferedInputStream(
								toClose_tFileInputExcel);
						workbook_tFileInputExcel = jxl.Workbook.getWorkbook(
								buffIStreamtFileInputExcel,
					...
					try {
						if (buffIStreamtFileInputExcel != null) {
							buffIStreamtFileInputExcel.close();
						}
					} catch (Exception e) {
					}
				}
				try {
					java.util.List<jxl.Sheet> sheetList_tFileInputExcel = java.util.Arrays
							.<jxl.Sheet> asList(workbook_tFileInputExcel
									.getSheets());
					if (sheetList_tFileInputExcel.size() <= 0) {
						throw new RuntimeException("Special sheets not exist!");
					}

					java.util.List<jxl.Sheet> sheet_FilterNullList_tFileInputExcel = new java.util.ArrayList<jxl.Sheet>();
					for (jxl.Sheet sheet_FilterNull_tFileInputExcel : sheetList_tFileInputExcel) {
						if (sheet_FilterNull_tFileInputExcel.getRows() > 0) {
							sheet_FilterNullList_tFileInputExcel
									.add(sheet_FilterNull_tFileInputExcel);
						}
					}
					sheetList_tFileInputExcel = sheet_FilterNullList_tFileInputExcel;
					if (sheetList_tFileInputExcel.size() > 0) {
						...
						for (jxl.Sheet sheet_tFileInputExcel : sheetList_tFileInputExcel) {
						...
						int end_column_tFileInputExcel = sheetList_tFileInputExcel
								.get(0).getColumns();
						jxl.Cell[] row_tFileInputExcel = null;
						jxl.Sheet sheet_tFileInputExcel = sheetList_tFileInputExcel
								.get(0);
						...
						java.text.DecimalFormat df_tFileInputExcel = new java.text.DecimalFormat(
								"#.####################################");
						char separatorChar_tFileInputExcel = df_tFileInputExcel
						...
						for (int i_tFileInputExcel = begin_line_tFileInputExcel; i_tFileInputExcel < end_line_tFileInputExcel; i_tFileInputExcel++) {
							...
							globalMap.put("tFileInputExcel_CURRENT_SHEET",
									sheet_tFileInputExcel.getName());
							Row = null;
							int tempRowLength_tFileInputExcel = 10;
							...
							int actual_end_column_tFileInputExcel = end_column_tFileInputExcel > row_tFileInputExcel.length ? row_tFileInputExcel.length
									: end_column_tFileInputExcel;

							java.util.TimeZone zone_tFileInputExcel = java.util.TimeZone
									.getTimeZone("GMT");
							java.text.SimpleDateFormat sdf_tFileInputExcel = new java.text.SimpleDateFormat(
									"dd-MM-yyyy");
							sdf_tFileInputExcel
									.setTimeZone(zone_tFileInputExcel);

							for (int i = 0; i < tempRowLength_tFileInputExcel; i++) {

								if (i + start_column_tFileInputExcel < actual_end_column_tFileInputExcel) {

									jxl.Cell cell_tFileInputExcel = row_tFileInputExcel[i
							...
							try {
								...
								if (temp_row_tFileInputExcel[columnIndex_tFileInputExcel]
										.length() > 0) {
							...
							if (Row != null) {
								...
								rowtFileOutputDelimited[0] = Row.A == null ? null
										: Row.A;
								rowtFileOutputDelimited[1] = Row.B == null ? null
										: Row.B;
								rowtFileOutputDelimited[2] = Row.C == null ? null
										: Row.C;
								rowtFileOutputDelimited[3] = Row.D == null ? null
										: Row.D;
								rowtFileOutputDelimited[4] = Row.E == null ? null
										: Row.E;
								rowtFileOutputDelimited[5] = Row.F == null ? null
										: Row.F;
								rowtFileOutputDelimited[6] = Row.G == null ? null
										: Row.G;
								rowtFileOutputDelimited[7] = Row.H == null ? null
										: Row.H;
								rowtFileOutputDelimited[8] = Row.I == null ? null
										: Row.I;
								rowtFileOutputDelimited[9] = Row.J == null ? null
										: Row.J;
								nb_line_tFileOutputDelimited++;
								resourceMap.put("nb_line_tFileOutputDelimited",
										nb_line_tFileOutputDelimited);
								...
								/**
								 * [tFileOutputDelimited process_data_begin ]
								 * start
								 */
								...
								/**
								 * [tFileOutputDelimited process_data_end ]
								 * start
								 */
					...
					if (!(source_tFileInputExcel instanceof java.io.InputStream)) {
						workbook_tFileInputExcel.close();
					}
		...
		try {
			...
			java.io.InputStream inContext = ShadowFileInputToDelimitedOutput.class
					.getClassLoader().getResourceAsStream(
							"recoupementfichiers/shadowfileinputtodelimitedoutput_0_1/contexts/"
...
/************************************************************************************************
 * 53108 characters generated by Talend Open Studio for MDM on the 27 mai 2019
 * 10:06:39 CEST
 ************************************************************************************************/
