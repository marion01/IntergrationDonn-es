...
package data_integration.shadowfileinputtodelimitedoutput_0_1;
...
public class ShadowFileInputToDelimitedOutput implements TalendJob {
	...
	public static class RowStruct implements
		...
		final static byte[] commonByteArrayLock_DATA_INTEGRATION_ShadowFileInputToDelimitedOutput = new byte[0];
		static byte[] commonByteArray_DATA_INTEGRATION_ShadowFileInputToDelimitedOutput = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DATA_INTEGRATION_ShadowFileInputToDelimitedOutput.length) {
					if (length < 1024
							&& commonByteArray_DATA_INTEGRATION_ShadowFileInputToDelimitedOutput.length == 0) {
						commonByteArray_DATA_INTEGRATION_ShadowFileInputToDelimitedOutput = new byte[1024];
					} else {
						commonByteArray_DATA_INTEGRATION_ShadowFileInputToDelimitedOutput = new byte[2 * length];
					}
				}
				dis.readFully(
						commonByteArray_DATA_INTEGRATION_ShadowFileInputToDelimitedOutput,
						0, length);
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DATA_INTEGRATION_ShadowFileInputToDelimitedOutput) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited = (new java.io.File(
						"C:/Users/mabertoni1.LOCAL/Desktop/ID/IntergrationDonnees/workspace/DATA_INTEGRATION/temp/preview/csp.csv"))
				...
				Object source_tFileInputExcel = "C:/ID/dataID/csp.xlsx";
				...
				if (source_tFileInputExcel instanceof String) {
					workbook_tFileInputExcel = new org.apache.poi.xssf.usermodel.XSSFWorkbook(
							(String) source_tFileInputExcel);
				} else if (source_tFileInputExcel instanceof java.io.InputStream) {
					workbook_tFileInputExcel = new org.apache.poi.xssf.usermodel.XSSFWorkbook(
							(java.io.InputStream) source_tFileInputExcel);
				} else {
				...
				try {
					...
					sheetList_tFileInputExcel
							.addAll(regexUtil_tFileInputExcel.getSheets(
									workbook_tFileInputExcel, "cspn2", false));
					...
					for (org.apache.poi.xssf.usermodel.XSSFSheet sheet_FilterNull_tFileInputExcel : sheetList_tFileInputExcel) {
						if (sheet_FilterNull_tFileInputExcel != null
								&& sheetList_FilterNull_tFileInputExcel
										.iterator() != null
								&& sheet_FilterNull_tFileInputExcel.iterator()
										.hasNext()) {
							sheetList_FilterNull_tFileInputExcel
					...
					if (sheetList_tFileInputExcel.size() > 0) {
						...
						int begin_line_tFileInputExcel = 1;
						...
						for (int i_tFileInputExcel = begin_line_tFileInputExcel; i_tFileInputExcel < end_line_tFileInputExcel; i_tFileInputExcel++) {
							...
							Row = null;
							int tempRowLength_tFileInputExcel = 2;
												...
												if (org.apache.poi.ss.usermodel.DateUtil
													...
													ne_tFileInputExcel = new org.apache.poi.ss.formula.eval.NumberEval(
															cell_tFileInputExcel
																	.getNumericCellValue());
													temp_row_tFileInputExcel[i] = ne_tFileInputExcel
															.getStringValue();
												}
												break;
											case org.apache.poi.ss.usermodel.Cell.CELL_TYPE_BOOLEAN:
		...
		try {
			...
			java.io.InputStream inContext = ShadowFileInputToDelimitedOutput.class
					.getClassLoader().getResourceAsStream(
							"data_integration/shadowfileinputtodelimitedoutput_0_1/contexts/"
...
/************************************************************************************************
 * 50046 characters generated by Talend Open Studio for MDM on the 14 juin 2019
 * 14:49:24 CEST
 ************************************************************************************************/
