...
package recoupementfichiers.threetoone_0_1;
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_RECOUPEMENTFICHIERS_ThreeToOne = new byte[0];
    static byte[] commonByteArray_RECOUPEMENTFICHIERS_ThreeToOne = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_RECOUPEMENTFICHIERS_ThreeToOne.length) {
				if(length < 1024 && commonByteArray_RECOUPEMENTFICHIERS_ThreeToOne.length == 0) {
   					commonByteArray_RECOUPEMENTFICHIERS_ThreeToOne = new byte[1024];
				} else {
   					commonByteArray_RECOUPEMENTFICHIERS_ThreeToOne = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_RECOUPEMENTFICHIERS_ThreeToOne, 0, length);
			strReturn = new String(commonByteArray_RECOUPEMENTFICHIERS_ThreeToOne, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_RECOUPEMENTFICHIERS_ThreeToOne) {
...
out3Struct out3 = new out3Struct();
	...
	currentComponent="tFileOutputExcel_1";
		...
		String fileName_tFileOutputExcel_1="C:/Talend/TOS_MDM-Studio-20180411_1414-V7.0.1/workspace/fusion.xls";
 ...
 */
	...
	currentComponent="tFileInputExcel_1";
		...
		Object source_tFileInputExcel_1 = "C:/Users/auchedotal/Documents/IntergrationDonnees/ConvocationsData/2008-2009_Septembre.xlsx";
 ...
 */
	...
	currentComponent="tFileInputExcel_2";
		...
		Object source_tFileInputExcel_2 = "C:/Users/auchedotal/Documents/IntergrationDonnees/ConvocationsData/2010-2011_Septembre.xlsx";
 ...
 */
	...
	currentComponent="tFileInputExcel_3";
		...
		Object source_tFileInputExcel_3 = "C:/Users/auchedotal/Documents/IntergrationDonnees/ConvocationsData/2011-2012_Septembre.xlsx";
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ThreeToOne.class.getClassLoader().getResourceAsStream("recoupementfichiers/threetoone_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     163335 characters generated by Talend Open Studio for MDM 
