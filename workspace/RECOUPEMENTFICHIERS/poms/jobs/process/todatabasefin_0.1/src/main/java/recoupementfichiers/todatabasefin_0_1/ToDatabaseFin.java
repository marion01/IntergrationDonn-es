...
package recoupementfichiers.todatabasefin_0_1;
...
public static class row6Struct implements routines.system.IPersistableRow<row6Struct> {
    final static byte[] commonByteArrayLock_RECOUPEMENTFICHIERS_ToDatabaseFin = new byte[0];
    static byte[] commonByteArray_RECOUPEMENTFICHIERS_ToDatabaseFin = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_RECOUPEMENTFICHIERS_ToDatabaseFin) {
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_RECOUPEMENTFICHIERS_ToDatabaseFin.length) {
				if(length < 1024 && commonByteArray_RECOUPEMENTFICHIERS_ToDatabaseFin.length == 0) {
   					commonByteArray_RECOUPEMENTFICHIERS_ToDatabaseFin = new byte[1024];
				} else {
   					commonByteArray_RECOUPEMENTFICHIERS_ToDatabaseFin = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_RECOUPEMENTFICHIERS_ToDatabaseFin, 0, length);
			strReturn = new String(commonByteArray_RECOUPEMENTFICHIERS_ToDatabaseFin, 0, length, utf8Charset);
		}
		return strReturn;
	}
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ToDatabaseFin.class.getClassLoader().getResourceAsStream("recoupementfichiers/todatabasefin_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     179916 characters generated by Talend Open Studio for MDM 
