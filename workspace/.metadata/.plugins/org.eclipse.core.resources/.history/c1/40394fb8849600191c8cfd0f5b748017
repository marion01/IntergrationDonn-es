...
package bdd_id.todatabase_epreuve_0_1;
...
public static class epreuveStruct implements routines.system.IPersistableRow<epreuveStruct> {
    final static byte[] commonByteArrayLock_BDD_ID_ToDatabase_Epreuve = new byte[0];
    static byte[] commonByteArray_BDD_ID_ToDatabase_Epreuve = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BDD_ID_ToDatabase_Epreuve.length) {
				if(length < 1024 && commonByteArray_BDD_ID_ToDatabase_Epreuve.length == 0) {
   					commonByteArray_BDD_ID_ToDatabase_Epreuve = new byte[1024];
				} else {
   					commonByteArray_BDD_ID_ToDatabase_Epreuve = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BDD_ID_ToDatabase_Epreuve, 0, length);
			strReturn = new String(commonByteArray_BDD_ID_ToDatabase_Epreuve, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BDD_ID_ToDatabase_Epreuve) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ToDatabase_Epreuve.class.getClassLoader().getResourceAsStream("bdd_id/todatabase_epreuve_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     102865 characters generated by Talend Open Studio for MDM 
 *     on the 24 juin 2019 15:13:43 CEST
 ************************************************************************************************/