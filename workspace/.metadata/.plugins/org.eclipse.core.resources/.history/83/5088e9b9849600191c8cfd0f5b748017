...
package bdd_id.todatabase__0_1;
...
public static class row10Struct implements routines.system.IPersistableRow<row10Struct> {
    final static byte[] commonByteArrayLock_BDD_ID_ToDatabase_ = new byte[0];
    static byte[] commonByteArray_BDD_ID_ToDatabase_ = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BDD_ID_ToDatabase_.length) {
				if(length < 1024 && commonByteArray_BDD_ID_ToDatabase_.length == 0) {
   					commonByteArray_BDD_ID_ToDatabase_ = new byte[1024];
				} else {
   					commonByteArray_BDD_ID_ToDatabase_ = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BDD_ID_ToDatabase_, 0, length);
			strReturn = new String(commonByteArray_BDD_ID_ToDatabase_, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BDD_ID_ToDatabase_) {
 ...
 */
	...
	currentComponent="tFileInputExcel_4";
        ...
        Object source_tFileInputExcel_4 ="C:/ID/out/fusion.xls";
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ToDatabase_.class.getClassLoader().getResourceAsStream("bdd_id/todatabase__0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     112744 characters generated by Talend Open Studio for MDM 
 *     on the 24 juin 2019 15:13:41 CEST
 ************************************************************************************************/