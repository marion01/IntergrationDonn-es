...
public void tDBRow_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	boolean whetherReject_tDBRow_3 = false;
			String driverClass_tDBRow_3 = "org.gjt.mm.mysql.Driver";
		    java.lang.Class.forName(driverClass_tDBRow_3);
		
				String url_tDBRow_3 = "jdbc:mysql://" + "localhost" + ":" + "3306" + "/" + "convocationrattrapage" + "?" + "noDatetimeStringSync=true";
					String dbUser_tDBRow_3 = "root";
	        
            		
            		
            		 
	final String decryptedPassword_tDBRow_3 = routines.system.PasswordEncryptUtil.decryptPassword("99a5c139d564b21c");
...
public void tDBRow_13Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tDBRow_13";
    	...
    	class BytesLimit65535_tDBRow_13{
    		public void limitLog4jByte() throws Exception{
    			
    		}
    	}
    	
        new BytesLimit65535_tDBRow_13().limitLog4jByte();

	java.sql.Connection conn_tDBRow_13 = null;
	String query_tDBRow_13 = "";
	boolean whetherReject_tDBRow_13 = false;
			String driverClass_tDBRow_13 = "org.gjt.mm.mysql.Driver";
		    java.lang.Class.forName(driverClass_tDBRow_13);
		
				String url_tDBRow_13 = "jdbc:mysql://" + "localhost" + ":" + "3306" + "/" + "convocationrattrapage" + "?" + "noDatetimeStringSync=true";
					String dbUser_tDBRow_13 = "root";
	        
            		
            		
            		 
	final String decryptedPassword_tDBRow_13 = routines.system.PasswordEncryptUtil.decryptPassword("99a5c139d564b21c");
...
public void tDBRow_5Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	boolean whetherReject_tDBRow_5 = false;
			String driverClass_tDBRow_5 = "org.gjt.mm.mysql.Driver";
		    java.lang.Class.forName(driverClass_tDBRow_5);
		
				String url_tDBRow_5 = "jdbc:mysql://" + "localhost" + ":" + "3306" + "/" + "convocationrattrapage" + "?" + "noDatetimeStringSync=true";
					String dbUser_tDBRow_5 = "root";
	        
            		
            		
            		 
	final String decryptedPassword_tDBRow_5 = routines.system.PasswordEncryptUtil.decryptPassword("99a5c139d564b21c");
...
public void tDBRow_7Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	boolean whetherReject_tDBRow_7 = false;
			String driverClass_tDBRow_7 = "org.gjt.mm.mysql.Driver";
		    java.lang.Class.forName(driverClass_tDBRow_7);
		
				String url_tDBRow_7 = "jdbc:mysql://" + "localhost" + ":" + "3306" + "/" + "convocationrattrapage" + "?" + "noDatetimeStringSync=true";
					String dbUser_tDBRow_7 = "root";
	        
            		
            		
            		 
	final String decryptedPassword_tDBRow_7 = routines.system.PasswordEncryptUtil.decryptPassword("99a5c139d564b21c");
...
public void tDBRow_9Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tDBRow_9";
    	...
    	class BytesLimit65535_tDBRow_9{
    		public void limitLog4jByte() throws Exception{
    			
    		}
    	}
    	
        new BytesLimit65535_tDBRow_9().limitLog4jByte();

	java.sql.Connection conn_tDBRow_9 = null;
	String query_tDBRow_9 = "";
	boolean whetherReject_tDBRow_9 = false;
			String driverClass_tDBRow_9 = "org.gjt.mm.mysql.Driver";
		    java.lang.Class.forName(driverClass_tDBRow_9);
		
				String url_tDBRow_9 = "jdbc:mysql://" + "localhost" + ":" + "3306" + "/" + "convocationrattrapage" + "?" + "noDatetimeStringSync=true";
					String dbUser_tDBRow_9 = "root";
	        
            		
            		
            		 
	final String decryptedPassword_tDBRow_9 = routines.system.PasswordEncryptUtil.decryptPassword("99a5c139d564b21c");
...
public void tDBRow_15Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tDBRow_15";
    	...
    	class BytesLimit65535_tDBRow_15{
    		public void limitLog4jByte() throws Exception{
    			
    		}
    	}
    	
        new BytesLimit65535_tDBRow_15().limitLog4jByte();

	java.sql.Connection conn_tDBRow_15 = null;
	String query_tDBRow_15 = "";
	boolean whetherReject_tDBRow_15 = false;
			String driverClass_tDBRow_15 = "org.gjt.mm.mysql.Driver";
		    java.lang.Class.forName(driverClass_tDBRow_15);
		
				String url_tDBRow_15 = "jdbc:mysql://" + "localhost" + ":" + "3306" + "/" + "convocationrattrapage" + "?" + "noDatetimeStringSync=true";
					String dbUser_tDBRow_15 = "root";
	        
            		
            		
            		 
	final String decryptedPassword_tDBRow_15 = routines.system.PasswordEncryptUtil.decryptPassword("99a5c139d564b21c");
        		   	
        	        String dbPwd_tDBRow_15 = decryptedPassword_tDBRow_15;
	        
					
			conn_tDBRow_15 = java.sql.DriverManager.getConnection(url_tDBRow_15,dbUser_tDBRow_15,dbPwd_tDBRow_15);
		
					if(conn_tDBRow_15.getAutoCommit()) {
						
				conn_tDBRow_15.setAutoCommit(false);
			
					}        
					int commitEvery_tDBRow_15 = 10000;
					int commitCounter_tDBRow_15 = 0;
...
try {
		...
		commitCounter_tDBRow_15++;
		if(commitEvery_tDBRow_15 <= commitCounter_tDBRow_15) {
			
			conn_tDBRow_15.commit();
			
			commitCounter_tDBRow_15=0;
		}
...
public void tDBRow_11Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tDBRow_11";
    	...
    	class BytesLimit65535_tDBRow_11{
    		public void limitLog4jByte() throws Exception{
    			
    		}
    	}
    	
        new BytesLimit65535_tDBRow_11().limitLog4jByte();

	java.sql.Connection conn_tDBRow_11 = null;
	String query_tDBRow_11 = "";
	boolean whetherReject_tDBRow_11 = false;
			String driverClass_tDBRow_11 = "org.gjt.mm.mysql.Driver";
		    java.lang.Class.forName(driverClass_tDBRow_11);
		
				String url_tDBRow_11 = "jdbc:mysql://" + "localhost" + ":" + "3306" + "/" + "convocationrattrapage" + "?" + "noDatetimeStringSync=true";
					String dbUser_tDBRow_11 = "root";
	        
            		
            		
            		 
	final String decryptedPassword_tDBRow_11 = routines.system.PasswordEncryptUtil.decryptPassword("99a5c139d564b21c");
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = DeleteDB.class.getClassLoader().getResourceAsStream("bdd_id/deletedb_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = DeleteDB.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
/************************************************************************************************
 *     57082 characters generated by Talend Open Studio for MDM 
 *     on the 24 juin 2019 15:13:32 CEST
 ************************************************************************************************/