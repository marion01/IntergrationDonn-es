...
package bdd_id.todatabaseconvocation_0_1;
...
public static class ConvocationStruct implements routines.system.IPersistableRow<ConvocationStruct> {
    final static byte[] commonByteArrayLock_BDD_ID_ToDatabaseConvocation = new byte[0];
    static byte[] commonByteArray_BDD_ID_ToDatabaseConvocation = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_BDD_ID_ToDatabaseConvocation) {
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_BDD_ID_ToDatabaseConvocation.length) {
				if(length < 1024 && commonByteArray_BDD_ID_ToDatabaseConvocation.length == 0) {
   					commonByteArray_BDD_ID_ToDatabaseConvocation = new byte[1024];
				} else {
   					commonByteArray_BDD_ID_ToDatabaseConvocation = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_BDD_ID_ToDatabaseConvocation, 0, length);
			strReturn = new String(commonByteArray_BDD_ID_ToDatabaseConvocation, 0, length, utf8Charset);
		}
		return strReturn;
	}
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ToDatabaseConvocation.class.getClassLoader().getResourceAsStream("bdd_id/todatabaseconvocation_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     75095 characters generated by Talend Open Studio for MDM 
 *     on the 24 juin 2019 15:13:44 CEST
 ************************************************************************************************/