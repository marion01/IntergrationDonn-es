...
package edd_id.fusion_promo_0_1;
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    final static byte[] commonByteArrayLock_EDD_ID_Fusion_Promo = new byte[0];
    static byte[] commonByteArray_EDD_ID_Fusion_Promo = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_EDD_ID_Fusion_Promo.length) {
				if(length < 1024 && commonByteArray_EDD_ID_Fusion_Promo.length == 0) {
   					commonByteArray_EDD_ID_Fusion_Promo = new byte[1024];
				} else {
   					commonByteArray_EDD_ID_Fusion_Promo = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_EDD_ID_Fusion_Promo, 0, length);
			strReturn = new String(commonByteArray_EDD_ID_Fusion_Promo, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_EDD_ID_Fusion_Promo) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Fusion_Promo.class.getClassLoader().getResourceAsStream("edd_id/fusion_promo_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     68117 characters generated by Talend Open Studio for MDM 
 *     on the 24 juin 2019 15:16:52 CEST
 ************************************************************************************************/