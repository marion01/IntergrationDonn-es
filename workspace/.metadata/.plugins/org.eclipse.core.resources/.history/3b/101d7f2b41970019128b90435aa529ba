...
public class Parent_job implements TalendJob {
	...
	public static class row1Struct implements
		...
		final static byte[] commonByteArrayLock_EDD_ID_Parent_job = new byte[0];
		static byte[] commonByteArray_EDD_ID_Parent_job = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_EDD_ID_Parent_job.length) {
					if (length < 1024
							&& commonByteArray_EDD_ID_Parent_job.length == 0) {
						commonByteArray_EDD_ID_Parent_job = new byte[1024];
					} else {
						commonByteArray_EDD_ID_Parent_job = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_EDD_ID_Parent_job, 0, length);
				strReturn = new String(commonByteArray_EDD_ID_Parent_job, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_EDD_ID_Parent_job) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				result_tFixedFlowInput_1
						.append("Q2xlYW5FREQNClBhcmVudF9mdXNpb24NClBhcnNlX1JlZ2lvbg0KTG9hZF9FREQNCkxvYWRfY3Nw");
				result_tFixedFlowInput_1
						.append("DQpDb3VudFJhdHRyYXBhZ2UNCkxvYWRFdHVkRUREMQ0K");
				...
				for (int i_tFixedFlowInput_1 = 0; i_tFixedFlowInput_1 < 1; i_tFixedFlowInput_1++) {
					...
					while (fid_tFixedFlowInput_1.nextRecord()) {
						...
						childJob_commandLine_tRunJob_1
								.add(dealChildJobLibrary_tRunJob_1
										.replaceJarPathsFromCrcMap(
												"C:/Talend/TOS_MDM-Studio-20180411_1414-V7.0.1/workspace/EDD_ID/poms/jobs/process/cleanedd_0.1/target/classpath.jar;")
										.replaceAll(";",
												classpathSeparator_tRunJob_1));

						childJob_commandLine_tRunJob_1
								.add("edd_id.cleanedd_0_1.CleanEDD".replaceAll(
										";", classpathSeparator_tRunJob_1));
						...
						childJob_commandLine_Mapper_tRunJob_1.put("CleanEDD",
								childJob_commandLine_tRunJob_1);
						...
						childJob_commandLine_tRunJob_1
								.add(dealChildJobLibrary_tRunJob_1
										.replaceJarPathsFromCrcMap(
												"C:/Talend/TOS_MDM-Studio-20180411_1414-V7.0.1/workspace/EDD_ID/poms/jobs/process/countrattrapage_0.1/target/classpath.jar;")
										.replaceAll(";",
												classpathSeparator_tRunJob_1));

						childJob_commandLine_tRunJob_1
								.add("edd_id.countrattrapage_0_1.CountRattrapage"
										.replaceAll(";",
												classpathSeparator_tRunJob_1));
						...
						childJob_commandLine_tRunJob_1
								.add(dealChildJobLibrary_tRunJob_1
										.replaceJarPathsFromCrcMap(
												"C:/Talend/TOS_MDM-Studio-20180411_1414-V7.0.1/workspace/EDD_ID/poms/jobs/process/fusion_apogee_0.1/target/classpath.jar;")
										.replaceAll(";",
												classpathSeparator_tRunJob_1));

						childJob_commandLine_tRunJob_1
								.add("edd_id.fusion_apogee_0_1.Fusion_Apogee"
										.replaceAll(";",
												classpathSeparator_tRunJob_1));
						...
						childJob_commandLine_tRunJob_1
								.add(dealChildJobLibrary_tRunJob_1
										.replaceJarPathsFromCrcMap(
												"C:/Talend/TOS_MDM-Studio-20180411_1414-V7.0.1/workspace/EDD_ID/poms/jobs/process/fusion_promo_0.1/target/classpath.jar;")
										.replaceAll(";",
												classpathSeparator_tRunJob_1));

						childJob_commandLine_tRunJob_1
								.add("edd_id.fusion_promo_0_1.Fusion_Promo"
										.replaceAll(";",
												classpathSeparator_tRunJob_1));
						...
						childJob_commandLine_Mapper_tRunJob_1.put(
								"Fusion_Promo", childJob_commandLine_tRunJob_1);
						...
						childJob_commandLine_tRunJob_1
								.add(dealChildJobLibrary_tRunJob_1
										.replaceJarPathsFromCrcMap(
												"C:/Talend/TOS_MDM-Studio-20180411_1414-V7.0.1/workspace/EDD_ID/poms/jobs/process/load_csp_0.1/target/classpath.jar;")
										.replaceAll(";",
												classpathSeparator_tRunJob_1));

						childJob_commandLine_tRunJob_1
								.add("edd_id.load_csp_0_1.Load_csp".replaceAll(
										";", classpathSeparator_tRunJob_1));
						...
						childJob_commandLine_Mapper_tRunJob_1.put("Load_csp",
								childJob_commandLine_tRunJob_1);
						...
						childJob_commandLine_tRunJob_1
								.add(dealChildJobLibrary_tRunJob_1
										.replaceJarPathsFromCrcMap(
												"C:/Talend/TOS_MDM-Studio-20180411_1414-V7.0.1/workspace/EDD_ID/poms/jobs/process/load_edd_0.1/target/classpath.jar;")
										.replaceAll(";",
												classpathSeparator_tRunJob_1));

						childJob_commandLine_tRunJob_1
								.add("edd_id.load_edd_0_1.Load_EDD".replaceAll(
										";", classpathSeparator_tRunJob_1));
						...
						childJob_commandLine_Mapper_tRunJob_1.put("Load_EDD",
								childJob_commandLine_tRunJob_1);
						...
						childJob_commandLine_tRunJob_1
								.add(dealChildJobLibrary_tRunJob_1
										.replaceJarPathsFromCrcMap(
												"C:/Talend/TOS_MDM-Studio-20180411_1414-V7.0.1/workspace/EDD_ID/poms/jobs/process/loadetudedd1_0.1/target/classpath.jar;")
										.replaceAll(";",
												classpathSeparator_tRunJob_1));

						childJob_commandLine_tRunJob_1
								.add("edd_id.loadetudedd1_0_1.LoadEtudEDD1"
										.replaceAll(";",
												classpathSeparator_tRunJob_1));
						...
						childJob_commandLine_Mapper_tRunJob_1.put(
								"LoadEtudEDD1", childJob_commandLine_tRunJob_1);
						...
						childJob_commandLine_tRunJob_1
								.add(dealChildJobLibrary_tRunJob_1
										.replaceJarPathsFromCrcMap(
												"C:/Talend/TOS_MDM-Studio-20180411_1414-V7.0.1/workspace/EDD_ID/poms/jobs/process/parent_fusion_0.1/target/classpath.jar;")
										.replaceAll(";",
												classpathSeparator_tRunJob_1));

						childJob_commandLine_tRunJob_1
								.add("edd_id.parent_fusion_0_1.Parent_fusion"
										.replaceAll(";",
												classpathSeparator_tRunJob_1));
						...
						childJob_commandLine_tRunJob_1
								.add(dealChildJobLibrary_tRunJob_1
										.replaceJarPathsFromCrcMap(
												"C:/Talend/TOS_MDM-Studio-20180411_1414-V7.0.1/workspace/EDD_ID/poms/jobs/process/parse_region_0.1/target/classpath.jar;")
										.replaceAll(";",
												classpathSeparator_tRunJob_1));

						childJob_commandLine_tRunJob_1
								.add("edd_id.parse_region_0_1.Parse_Region"
										.replaceAll(";",
												classpathSeparator_tRunJob_1));
						...
						childJob_commandLine_Mapper_tRunJob_1.put(
								"Parse_Region", childJob_commandLine_tRunJob_1);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Parent_job.class.getClassLoader()
					.getResourceAsStream(
							"edd_id/parent_job_0_1/contexts/" + contextStr
									+ ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 55122 characters generated by Talend Open Studio for MDM on the 24 juin 2019
 * 15:17:05 CEST
 ************************************************************************************************/
