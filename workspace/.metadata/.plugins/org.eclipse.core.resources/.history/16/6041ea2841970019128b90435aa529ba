		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Load_EDD.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row8Struct implements routines.system.IPersistableRow<row8Struct> {
    final static byte[] commonByteArrayLock_EDD_ID_Load_EDD = new byte[0];
    static byte[] commonByteArray_EDD_ID_Load_EDD = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_EDD_ID_Load_EDD.length) {
				if(length < 1024 && commonByteArray_EDD_ID_Load_EDD.length == 0) {
   					commonByteArray_EDD_ID_Load_EDD = new byte[1024];
				} else {
   					commonByteArray_EDD_ID_Load_EDD = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_EDD_ID_Load_EDD, 0, length);
			strReturn = new String(commonByteArray_EDD_ID_Load_EDD, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_EDD_ID_Load_EDD) {
    ...
    public int compareTo(row8Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.provenance, other.provenance);
						if(returnValue != 0) {
							return returnValue;
						}
...
public static class row7Struct implements routines.system.IPersistableRow<row7Struct> {
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.nationalite == null) ? 0 : this.nationalite.hashCode());
    ...
    public int compareTo(row7Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.nationalite, other.nationalite);
						if(returnValue != 0) {
							return returnValue;
						}
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.bac == null) ? 0 : this.bac.hashCode());
...
public static class row5Struct implements routines.system.IPersistableRow<row5Struct> {
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.codeEtudiant == null) ? 0 : this.codeEtudiant.hashCode());
    ...
    public int compareTo(row5Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.codeEtudiant, other.codeEtudiant);
						if(returnValue != 0) {
							return returnValue;
						}
...
public static class d_ageStruct implements routines.system.IPersistableRow<d_ageStruct> {
    final static byte[] commonByteArrayLock_EDD_ID_Load_EDD = new byte[0];
    static byte[] commonByteArray_EDD_ID_Load_EDD = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
...
public static class d_etuStruct implements routines.system.IPersistableRow<d_etuStruct> {
    final static byte[] commonByteArrayLock_EDD_ID_Load_EDD = new byte[0];
    static byte[] commonByteArray_EDD_ID_Load_EDD = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
...
public static class d_bacStruct implements routines.system.IPersistableRow<d_bacStruct> {
    final static byte[] commonByteArrayLock_EDD_ID_Load_EDD = new byte[0];
    static byte[] commonByteArray_EDD_ID_Load_EDD = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
...
public static class d_geoStruct implements routines.system.IPersistableRow<d_geoStruct> {
    final static byte[] commonByteArrayLock_EDD_ID_Load_EDD = new byte[0];
    static byte[] commonByteArray_EDD_ID_Load_EDD = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
...
public static class d_nationaliteStruct implements routines.system.IPersistableRow<d_nationaliteStruct> {
    final static byte[] commonByteArrayLock_EDD_ID_Load_EDD = new byte[0];
    static byte[] commonByteArray_EDD_ID_Load_EDD = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
...
public static class d_provenanceStruct implements routines.system.IPersistableRow<d_provenanceStruct> {
    final static byte[] commonByteArrayLock_EDD_ID_Load_EDD = new byte[0];
    static byte[] commonByteArray_EDD_ID_Load_EDD = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
...
java.sql.Connection conn_tDBOutput_10 = null;
		...
		if(dbProperties_tDBOutput_10 == null || dbProperties_tDBOutput_10.trim().length() == 0) {
			url_tDBOutput_10 = "jdbc:mysql://" + "localhost" + ":" + "3306" + "/" + "entrepotrattrapage" + "?" + "rewriteBatchedStatements=true";
		} else {
			...
			url_tDBOutput_10 = "jdbc:mysql://" + "localhost" + ":" + "3306" + "/" + "entrepotrattrapage" + "?" + properties_tDBOutput_10;
		}
	...
	final String decryptedPassword_tDBOutput_10 = routines.system.PasswordEncryptUtil.decryptPassword("99a5c139d564b21c");
...
int count_tDBOutput_10=0;
            ...
            java.sql.Statement stmtClear_tDBOutput_10 = conn_tDBOutput_10.createStatement();
            stmtClear_tDBOutput_10.executeUpdate("DELETE FROM `" + tableName_tDBOutput_10 + "`");
            stmtClear_tDBOutput_10.close();

				String insert_tDBOutput_10 = "INSERT INTO `" + "d_age" + "` (`age`,`cat_age`) VALUES (?,?)";
	...
	currentComponent="tUniqRow_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("d_age" + iterateId, 0, 0);
...
java.sql.Connection conn_tDBOutput_6 = null;
		...
		if(dbProperties_tDBOutput_6 == null || dbProperties_tDBOutput_6.trim().length() == 0) {
			url_tDBOutput_6 = "jdbc:mysql://" + "localhost" + ":" + "3306" + "/" + "entrepotrattrapage" + "?" + "rewriteBatchedStatements=true";
		} else {
			...
			url_tDBOutput_6 = "jdbc:mysql://" + "localhost" + ":" + "3306" + "/" + "entrepotrattrapage" + "?" + properties_tDBOutput_6;
		}
...
int count_tDBOutput_6=0;
            ...
            stmtClear_tDBOutput_6.close();
				...
				String insert_tDBOutput_6 = "INSERT INTO `" + "d_etu" + "` (`codeEtudiant`,`nom`,`prenom`) VALUES (?,?,?)";
	...
	currentComponent="tUniqRow_4";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("d_etu" + iterateId, 0, 0);
...
java.sql.Connection conn_tDBOutput_2 = null;
		...
		if(dbProperties_tDBOutput_2 == null || dbProperties_tDBOutput_2.trim().length() == 0) {
			url_tDBOutput_2 = "jdbc:mysql://" + "localhost" + ":" + "3306" + "/" + "entrepotrattrapage" + "?" + "rewriteBatchedStatements=true";
		} else {
			...
			url_tDBOutput_2 = "jdbc:mysql://" + "localhost" + ":" + "3306" + "/" + "entrepotrattrapage" + "?" + properties_tDBOutput_2;
		}
...
int count_tDBOutput_2=0;
            ...
            stmtClear_tDBOutput_2.close();
				...
				String insert_tDBOutput_2 = "INSERT INTO `" + "d_bac" + "` (`bac`,`cat_bac`) VALUES (?,?)";
	...
	currentComponent="tUniqRow_3";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("d_bac" + iterateId, 0, 0);
...
java.sql.Connection conn_tDBOutput_8 = null;
		...
		if(dbProperties_tDBOutput_8 == null || dbProperties_tDBOutput_8.trim().length() == 0) {
			url_tDBOutput_8 = "jdbc:mysql://" + "localhost" + ":" + "3306" + "/" + "entrepotrattrapage" + "?" + "rewriteBatchedStatements=true";
		} else {
			...
			url_tDBOutput_8 = "jdbc:mysql://" + "localhost" + ":" + "3306" + "/" + "entrepotrattrapage" + "?" + properties_tDBOutput_8;
		}
	...
	final String decryptedPassword_tDBOutput_8 = routines.system.PasswordEncryptUtil.decryptPassword("99a5c139d564b21c");
...
int count_tDBOutput_8=0;
            ...
            java.sql.Statement stmtClear_tDBOutput_8 = conn_tDBOutput_8.createStatement();
            stmtClear_tDBOutput_8.executeUpdate("DELETE FROM `" + tableName_tDBOutput_8 + "`");
            stmtClear_tDBOutput_8.close();

				String insert_tDBOutput_8 = "INSERT INTO `" + "d_geo" + "` (`ville`,`dept`,`region`,`pays`) VALUES (?,?,?,?)";
	...
	currentComponent="tUniqRow_5";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("d_geo" + iterateId, 0, 0);
...
java.sql.Connection conn_tDBOutput_11 = null;
		...
		if(dbProperties_tDBOutput_11 == null || dbProperties_tDBOutput_11.trim().length() == 0) {
			url_tDBOutput_11 = "jdbc:mysql://" + "localhost" + ":" + "3306" + "/" + "entrepotrattrapage" + "?" + "rewriteBatchedStatements=true";
		} else {
			...
			url_tDBOutput_11 = "jdbc:mysql://" + "localhost" + ":" + "3306" + "/" + "entrepotrattrapage" + "?" + properties_tDBOutput_11;
		}
	...
	final String decryptedPassword_tDBOutput_11 = routines.system.PasswordEncryptUtil.decryptPassword("99a5c139d564b21c");
...
int count_tDBOutput_11=0;
            ...
            java.sql.Statement stmtClear_tDBOutput_11 = conn_tDBOutput_11.createStatement();
            stmtClear_tDBOutput_11.executeUpdate("DELETE FROM `" + tableName_tDBOutput_11 + "`");
            stmtClear_tDBOutput_11.close();

				String insert_tDBOutput_11 = "INSERT INTO `" + "d_nationalite" + "` (`nationalite`,`cat_nationalite`) VALUES (?,?)";
	...
	currentComponent="tUniqRow_6";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("d_nationalite" + iterateId, 0, 0);
...
java.sql.Connection conn_tDBOutput_13 = null;
		...
		if(dbProperties_tDBOutput_13 == null || dbProperties_tDBOutput_13.trim().length() == 0) {
			url_tDBOutput_13 = "jdbc:mysql://" + "localhost" + ":" + "3306" + "/" + "entrepotrattrapage" + "?" + "rewriteBatchedStatements=true";
		} else {
			...
			url_tDBOutput_13 = "jdbc:mysql://" + "localhost" + ":" + "3306" + "/" + "entrepotrattrapage" + "?" + properties_tDBOutput_13;
		}
	...
	final String decryptedPassword_tDBOutput_13 = routines.system.PasswordEncryptUtil.decryptPassword("99a5c139d564b21c");
...
int count_tDBOutput_13=0;
            ...
            java.sql.Statement stmtClear_tDBOutput_13 = conn_tDBOutput_13.createStatement();
            stmtClear_tDBOutput_13.executeUpdate("DELETE FROM `" + tableName_tDBOutput_13 + "`");
            stmtClear_tDBOutput_13.close();

				String insert_tDBOutput_13 = "INSERT INTO `" + "d_provenance" + "` (`provenance`,`cat_provenance`) VALUES (?,?)";
	...
	currentComponent="tUniqRow_8";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("d_provenance" + iterateId, 0, 0);
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_1 = "C:/ID/out/fusionDataEDD.csv";
			...
			if(footer_value_tFileInputDelimited_1 >0 || random_value_tFileInputDelimited_1 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited("C:/ID/out/fusionDataEDD.csv", "windows-1252",";","\n",true,1,0,-1,-1, false);
				...
				int columnIndexWithD_tFileInputDelimited_1 = 0;
					...
					columnIndexWithD_tFileInputDelimited_1 = 0;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row1.code_etu = ParserUtils.parseTo_Integer(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_1) {
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"code_etu", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 1;
							...
							row1.annee = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1).trim();
						
				
					columnIndexWithD_tFileInputDelimited_1 = 2;
					
							row1.nom_patro = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1).trim();
						
				
					columnIndexWithD_tFileInputDelimited_1 = 3;
					
							row1.prenom = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1).trim();
						
				
					columnIndexWithD_tFileInputDelimited_1 = 4;
					
							row1.date_naiss = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1).trim();
						
				
					columnIndexWithD_tFileInputDelimited_1 = 5;
					
							row1.sexe = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1).trim();
						
				
					columnIndexWithD_tFileInputDelimited_1 = 6;
					
							row1.nationalite = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1).trim();
						
				
					columnIndexWithD_tFileInputDelimited_1 = 7;
					
							row1.bac = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1).trim();
						
				
					columnIndexWithD_tFileInputDelimited_1 = 8;
					
							row1.bur_distr = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1).trim();
						
				
					columnIndexWithD_tFileInputDelimited_1 = 9;
					
							row1.etape = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1).trim();
					...
					columnIndexWithD_tFileInputDelimited_1 = 10;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row1.csp_par = ParserUtils.parseTo_Integer(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_1) {
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"csp_par", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 11;
							...
							row1.promo = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1).trim();
						
				
					columnIndexWithD_tFileInputDelimited_1 = 12;
					
							row1.niveau = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1).trim();
						
				
					columnIndexWithD_tFileInputDelimited_1 = 13;
					
							row1.Groupe = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1).trim();
						
				
					columnIndexWithD_tFileInputDelimited_1 = 14;
					
							row1.Lv2 = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1).trim();
						
				
					columnIndexWithD_tFileInputDelimited_1 = 15;
					
							row1.Provenance = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1).trim();
						
				
					columnIndexWithD_tFileInputDelimited_1 = 16;
					
							row1.cod_pays = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1).trim();
						
				
					columnIndexWithD_tFileInputDelimited_1 = 17;
					
							row1.cod_dep = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1).trim();
						
				
					columnIndexWithD_tFileInputDelimited_1 = 18;
					
							row1.cod_post = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1).trim();
...
Var.annee_naiss = StringHandling.RIGHT(row1.date_naiss ,4) ;
Var.annee_naiss_date = TalendDate.parseDate("yyyy",Var.annee_naiss );
Var.var2 = TalendDate.parseDate("yyyy", row1.annee) ;
Var.age = (int)TalendDate.diffDate(Var.var2,Var.annee_naiss_date,"yyyy") ;
Var.cat_age = Var.age < 20 ? "16-20" : (20 <= Var.age && Var.age <= 25 ? "20-25" : "+25") ;
Var.cat_nat = row1.nationalite.equals("FRANCAIS(E)") ? "FRANCAIS(E)" : "ETRANGER(E)" ;
Var.cat_bac = row1.bac.equals("S") ? "Général" :
row1.bac.equals("ES") ? "Général" :
row1.bac.equals("B") ? "Général" :
row1.bac.equals("C") ? "Général" :
row1.bac.equals("D") ? "Général" :
row1.bac.matches("ST.*") ? "Technologique" :
row1.bac.equals("F3") ? "Technologique" :
row1.bac.matches("[0-9]+") ? "Etranger" : "Autre" ;
Var.cat_provenance = row1.Provenance.contains("Lic") ? "Fac" :
row1.Provenance.contains("Master") ? "Fac" :
row1.Provenance.matches("L[0-9].*") ? "Fac" :
row1.Provenance.contains("L Pro") ? "Fac" :
row1.Provenance.contains("DUT") ? "DUT" :
row1.Provenance.contains("BTS") ? "BTS" :
row1.Provenance.contains("MP") ? "Prépa" :
row1.Provenance.contains("PC") ? "Prépa" :
row1.Provenance.contains("PSI") ? "Prépa" :
row1.Provenance.contains("TSI") ? "Prépa" :
row1.Provenance.contains("PT") ? "Prépa" : "Autre" ;// ###############################
        // ###############################
        // # Output tables
...
if(d_age != null) { 
	...
	currentComponent="tUniqRow_1";
			...
			//d_age
				...
				if(execStat){
					runStat.updateStatOnConnection("d_age"+iterateId,1, 1);
				} 
...
new_tUniqRow_1.age = d_age.age;
	...
	row2 = new row2Struct();
}row2.age = d_age.age;			row2.cat_age = d_age.cat_age;					
...
if(row2 != null) { 
	...
	currentComponent="tDBOutput_10";
        ...
        whetherReject_tDBOutput_10 = false;
                            pstmt_tDBOutput_10.setInt(1, row2.age);

                            if(row2.cat_age == null) {
pstmt_tDBOutput_10.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_10.setString(2, row2.cat_age);
}
...
if(d_etu != null) { 
	...
	currentComponent="tUniqRow_4";
			...
			//d_etu
				...
				if(execStat){
					runStat.updateStatOnConnection("d_etu"+iterateId,1, 1);
				} 
...
new_tUniqRow_4.codeEtudiant = d_etu.codeEtudiant;
	...
	row5 = new row5Struct();
}row5.codeEtudiant = d_etu.codeEtudiant;			row5.nom = d_etu.nom;			row5.prenom = d_etu.prenom;					
...
} else {pstmt_tDBOutput_6.setInt(1, row5.codeEtudiant);
}

                            if(row5.nom == null) {
pstmt_tDBOutput_6.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(2, row5.nom);
}

                            if(row5.prenom == null) {
pstmt_tDBOutput_6.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(3, row5.prenom);
}
...
if(d_bac != null) { 
	...
	currentComponent="tUniqRow_3";
			...
			//d_bac
				...
				if(execStat){
					runStat.updateStatOnConnection("d_bac"+iterateId,1, 1);
				} 
...
new_tUniqRow_3.bac = d_bac.bac;
		...
		keystUniqRow_3.add(new_tUniqRow_3);if(row3 == null){ 
	
	row3 = new row3Struct();
}row3.bac = d_bac.bac;			row3.cat_bac = d_bac.cat_bac;					
...
} else {pstmt_tDBOutput_2.setString(1, row3.bac);
}

                            if(row3.cat_bac == null) {
pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(2, row3.cat_bac);
}
...
if(d_geo != null) { 
	...
	currentComponent="tUniqRow_5";
			...
			//d_geo
				...
				if(execStat){
					runStat.updateStatOnConnection("d_geo"+iterateId,1, 1);
				} 
...
if(d_geo.ville == null){
	...
	finder_tUniqRow_5.ville = d_geo.ville.toLowerCase();
}	
...
if(d_geo.ville == null){
	...
	new_tUniqRow_5.ville = d_geo.ville.toLowerCase();
}
		
		keystUniqRow_5.add(new_tUniqRow_5);if(row6 == null){ 
	
	row6 = new row6Struct();
}row6.ville = d_geo.ville;			row6.dept = d_geo.dept;			row6.region = d_geo.region;			row6.pays = d_geo.pays;					
...
} else {pstmt_tDBOutput_8.setString(1, row6.ville);
}

                            if(row6.dept == null) {
pstmt_tDBOutput_8.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_8.setString(2, row6.dept);
}

                            if(row6.region == null) {
pstmt_tDBOutput_8.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_8.setString(3, row6.region);
}

                            if(row6.pays == null) {
pstmt_tDBOutput_8.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_8.setString(4, row6.pays);
}
...
if(d_nationalite != null) { 
	...
	currentComponent="tUniqRow_6";
			...
			//d_nationalite
				...
				if(execStat){
					runStat.updateStatOnConnection("d_nationalite"+iterateId,1, 1);
				} 
...
new_tUniqRow_6.nationalite = d_nationalite.nationalite;
	...
	row7 = new row7Struct();
}row7.nationalite = d_nationalite.nationalite;			row7.cat_nationalite = d_nationalite.cat_nationalite;					
...
} else {pstmt_tDBOutput_11.setString(1, row7.nationalite);
}

                            if(row7.cat_nationalite == null) {
pstmt_tDBOutput_11.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_11.setString(2, row7.cat_nationalite);
}
...
if(d_provenance != null) { 
	...
	currentComponent="tUniqRow_8";
			...
			//d_provenance
				...
				if(execStat){
					runStat.updateStatOnConnection("d_provenance"+iterateId,1, 1);
				} 
...
new_tUniqRow_8.provenance = d_provenance.provenance;
	...
	row8 = new row8Struct();
}row8.provenance = d_provenance.provenance;			row8.cat_provenance = d_provenance.cat_provenance;					
...
} else {pstmt_tDBOutput_13.setString(1, row8.provenance);
}

                            if(row8.cat_provenance == null) {
pstmt_tDBOutput_13.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_13.setString(2, row8.cat_provenance);
}
 ...
 */
	...
	currentComponent="tFileInputDelimited_1";
                ...
                if(!((Object)("C:/ID/out/fusionDataEDD.csv") instanceof java.io.InputStream)){
...
globalMap.put("tUniqRow_1_NB_DUPLICATES",nb_duplicates_tUniqRow_1);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("d_age"+iterateId,2, 0); 
			 	}
			}
...
globalMap.put("tUniqRow_4_NB_DUPLICATES",nb_duplicates_tUniqRow_4);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("d_etu"+iterateId,2, 0); 
			 	}
			}
...
globalMap.put("tUniqRow_3_NB_DUPLICATES",nb_duplicates_tUniqRow_3);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("d_bac"+iterateId,2, 0); 
			 	}
			}
...
globalMap.put("tUniqRow_5_NB_DUPLICATES",nb_duplicates_tUniqRow_5);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("d_geo"+iterateId,2, 0); 
			 	}
			}
...
globalMap.put("tUniqRow_6_NB_DUPLICATES",nb_duplicates_tUniqRow_6);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("d_nationalite"+iterateId,2, 0); 
			 	}
			}
...
globalMap.put("tUniqRow_8_NB_DUPLICATES",nb_duplicates_tUniqRow_8);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("d_provenance"+iterateId,2, 0); 
			 	}
			}
		...
		if(resourceMap.get("finish_tDBOutput_10")==null){
			if(resourceMap.get("conn_tDBOutput_10")!=null){
				try {
					...
					java.sql.Connection ctn_tDBOutput_10 = (java.sql.Connection)resourceMap.get("conn_tDBOutput_10");
		...
		if(resourceMap.get("finish_tDBOutput_8")==null){
			if(resourceMap.get("conn_tDBOutput_8")!=null){
				try {
					...
					java.sql.Connection ctn_tDBOutput_8 = (java.sql.Connection)resourceMap.get("conn_tDBOutput_8");
		...
		if(resourceMap.get("finish_tDBOutput_11")==null){
			if(resourceMap.get("conn_tDBOutput_11")!=null){
				try {
					...
					java.sql.Connection ctn_tDBOutput_11 = (java.sql.Connection)resourceMap.get("conn_tDBOutput_11");
		...
		if(resourceMap.get("finish_tDBOutput_13")==null){
			if(resourceMap.get("conn_tDBOutput_13")!=null){
				try {
					...
					java.sql.Connection ctn_tDBOutput_13 = (java.sql.Connection)resourceMap.get("conn_tDBOutput_13");
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.COG == null) ? 0 : this.COG.hashCode());
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row10";
        ...
        new BytesLimit65535_tAdvancedHash_row10().limitLog4jByte();
			   		...
			   		// source node:tFileInputDelimited_3 - inputs:(after_tFileInputDelimited_1) outputs:(row10,row10) | target node:tAdvancedHash_row10 - inputs:(row10) outputs:()
			   		// linked node: tMap_1 - inputs:(row1,row10,row9) outputs:(d_age,d_etu,d_bac,d_geo,d_nationalite,d_provenance)
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_3 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_3 = "C:/ID/dataEntrepot/pays.txt";
			...
			if(footer_value_tFileInputDelimited_3 >0 || random_value_tFileInputDelimited_3 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_3 = new org.talend.fileprocess.FileInputDelimited("C:/ID/dataEntrepot/pays.txt", "windows-1252","\t","\n",false,1,0,-1,-1, false);
						} catch(java.lang.Exception e) {
				...
				int columnIndexWithD_tFileInputDelimited_3 = 0;
					...
					columnIndexWithD_tFileInputDelimited_3 = 0;
							...
							row10.COG = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3).trim();
					...
					columnIndexWithD_tFileInputDelimited_3 = 1;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row10.ACTUAL = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"ACTUAL", "row10", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
					...
					columnIndexWithD_tFileInputDelimited_3 = 2;
							...
							row10.CAPAY = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3).trim();
						
				
					columnIndexWithD_tFileInputDelimited_3 = 3;
					
							row10.CRPAY = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3).trim();
						
				
					columnIndexWithD_tFileInputDelimited_3 = 4;
					
							row10.ANI = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3).trim();
						
				
					columnIndexWithD_tFileInputDelimited_3 = 5;
					
							row10.LIBCOG = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3).trim();
						
				
					columnIndexWithD_tFileInputDelimited_3 = 6;
					
							row10.LIBENR = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3).trim();
						
				
					columnIndexWithD_tFileInputDelimited_3 = 7;
					
							row10.ANCNOM = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3).trim();
 ...
 */
	...
	currentComponent="tFileInputDelimited_3";
                ...
                if(!((Object)("C:/ID/dataEntrepot/pays.txt") instanceof java.io.InputStream)){
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.DEP == null) ? 0 : this.DEP.hashCode());
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_2 = "C:/ID/out/regiondept.csv";
			...
			if(footer_value_tFileInputDelimited_2 >0 || random_value_tFileInputDelimited_2 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_2 = new org.talend.fileprocess.FileInputDelimited("C:/ID/out/regiondept.csv", "windows-1252",";","\n",false,1,0,-1,-1, false);
						} catch(java.lang.Exception e) {
				...
				int columnIndexWithD_tFileInputDelimited_2 = 0;
					...
					columnIndexWithD_tFileInputDelimited_2 = 0;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row9.REGION = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"REGION", "row9", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
					...
					columnIndexWithD_tFileInputDelimited_2 = 1;
							...
							row9.DEP = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2).trim();
						
				
					columnIndexWithD_tFileInputDelimited_2 = 2;
					
							row9.CHEFLIEU_DEP = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2).trim();
					...
					columnIndexWithD_tFileInputDelimited_2 = 3;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row9.TNCC_DEP = ParserUtils.parseTo_Integer(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_2) {
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"TNCC_DEP", "row9", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
					...
					columnIndexWithD_tFileInputDelimited_2 = 4;
							...
							row9.NCC_DEP = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2).trim();
						
				
					columnIndexWithD_tFileInputDelimited_2 = 5;
					
							row9.NCCENR_DEP = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2).trim();
						
				
					columnIndexWithD_tFileInputDelimited_2 = 6;
					
							row9.CHEFLIEU_REG = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2).trim();
					...
					columnIndexWithD_tFileInputDelimited_2 = 7;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row9.TNCC_REG = ParserUtils.parseTo_Integer(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_2) {
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"TNCC_REG", "row9", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
					...
					columnIndexWithD_tFileInputDelimited_2 = 8;
							...
							row9.NCC_REG = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2).trim();
						
				
					columnIndexWithD_tFileInputDelimited_2 = 9;
					
							row9.NCCENR_REG = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2).trim();
 ...
 */
	...
	currentComponent="tFileInputDelimited_2";
                ...
                if(!((Object)("C:/ID/out/regiondept.csv") instanceof java.io.InputStream)){
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Load_EDD.class.getClassLoader().getResourceAsStream("edd_id/load_edd_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Load_EDD.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Load_EDD");
        }
...
/************************************************************************************************
 *     253246 characters generated by Talend Open Studio for MDM 
 *     on the 24 juin 2019 15:16:59 CEST
 ************************************************************************************************/